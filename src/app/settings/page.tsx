  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-white px-4 py-4 flex items-center justify-center relative border-b border-gray-200">
        <ChevronLeft className="w-6 h-6 text-gray-600 absolute left-4" />
      ...
      <div className="bg-white">
        ...
        <div className="px-4 py-2">
          ...
          />
          <SettingItem icon={<Bell />} title="Custom Notification" highlighted />
...
const SettingItem = ({ icon, title, right, highlighted = false }: SettingItemProps) => (
  <div className={`flex items-center justify-between py-4 ${highlighted ? "bg-gray-100" : ""}`}>
    <div className="flex items-center gap-3">
...
const SettingToggle = ({ icon, title, enabled, onToggle }: SettingToggleProps) => (
  <div className="flex items-center justify-between py-4">
    <div className="flex items-center gap-3">
      <span className="text-gray-600">{icon}</span>
      <span className="text-gray-900 font-medium">{title}</span>
